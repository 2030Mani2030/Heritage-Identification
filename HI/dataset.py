...
class Dataset(torch.utils.data.Dataset):
    ...
    def __init__(self, is_train, root_dir="/content/Heritage-Identification/HI/Dataset", transform=None, seed=42, download=False):
    ...
    def download_dataset(self) -> None:
        ...
        download_and_extract_archive(
            "/content/Heritage-Identification/HI/Dataset.zip",
